...
namespace Sudoku
{
    ...
    public class SudokuBoard
    {
        ...
        public bool RowHasNumberInAnyEntry(int rowIndex, int number)
        {
        ...
        public bool ColumnHasNumberInAnyEntry(int columnIndex, int number)
        {
            bool returnValue = false;
            int i = 0;
        ...
        public bool SquareHasNumberInAnyEntry(int squareIndex, int number)
        {
            bool returnValue = false;
            int i = 0;
